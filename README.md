...
|---------|-------------|------------|
| **[LFU Sys](https://github.com/Yulian302/lfusys)** | Scalable distributed large file upload system | Go (REST, gRPC), Docker, AWS (S3, DynamoDB, EC2, SQS), Terraform, React (TS) |
